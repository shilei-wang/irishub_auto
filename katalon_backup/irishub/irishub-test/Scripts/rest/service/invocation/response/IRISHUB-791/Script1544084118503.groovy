...
WS.verifyEqual(re.get("provider").getAsString(), BaseTxInfo[1])
WS.verifyEqual(re.get("consumer").getAsString(), BaseTxInfo[1])
WS.verifyEqual(re.get("output").getAsString(), responseData.getValue("output", 1) )
