...
valFaaAddr = AccountUtils.getAddrByName(valName, "acc")
valFvaAddr = AccountUtils.getAddrByName(valName, "val")
...
userFaaAddr = AccountUtils.getAddrByName(user1.get("name"), "acc")
userFvaAddr = AccountUtils.getAddrByName(user1.get("name"), "val")

WS.verifyEqual(userFaaAddr.contains("faa"), true)
WS.verifyEqual(userFvaAddr.contains("fva"), true)
WS.verifyEqual(userFaaAddr, userFaaAddr)
