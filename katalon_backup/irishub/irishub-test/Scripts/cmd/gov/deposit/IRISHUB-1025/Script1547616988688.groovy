...
proposal_id = GovUtils.submitProposal(u.v0, u.td.getValue("submit_deposit", 1))
cmd = u.command+" --deposit="+u.td.getValue("deposit", 1)+" --proposal-id="+proposal_id
...
class Utils {
	...
	public Utils(){
		td = findTestData('gov/deposit/IRISHUB-1025')
