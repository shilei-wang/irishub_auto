...
class Utils {
	...
	public Utils(){
		...
		command = 'iriscli stake unbond begin'.concat(GlobalVariable.chainId).concat(GlobalVariable.node)
			.concat(' --from=').concat(user).concat(" --address-validator=").concat(v0_fva)
