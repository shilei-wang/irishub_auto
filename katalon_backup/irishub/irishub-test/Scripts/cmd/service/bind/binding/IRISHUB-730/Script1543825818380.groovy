...
class Utils {
	...
	public Utils(){		
		...
		command = 'iriscli service binding'.concat(GlobalVariable.chainId).concat(GlobalVariable.defchainId).concat(GlobalVariable.bindchainId).concat(GlobalVariable.node)
