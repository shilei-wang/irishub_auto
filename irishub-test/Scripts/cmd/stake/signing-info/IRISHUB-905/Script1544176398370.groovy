...
WS.verifyEqual(StringUtils.stringContains(response.responseBodyContent,"Start height"), true)
...
class Utils {
	...
	public Utils(){
		...
		command = 'iriscli stake signing-info'.concat(' --node=').concat(GlobalVariable.node).concat(' ')+v0_fvp	
	}
}
