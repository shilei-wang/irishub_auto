...
class Utils {
	...
	public Utils(){
		...
		command = 'iriscli stake redelegate --chain-id='.concat(GlobalVariable.chainId).concat(' --node=').concat(GlobalVariable.node).concat(
				' --from=').concat(user).concat(" --address-validator-source=").concat(v0_fva).concat(" --address-validator-dest=").concat(v1_fva)
