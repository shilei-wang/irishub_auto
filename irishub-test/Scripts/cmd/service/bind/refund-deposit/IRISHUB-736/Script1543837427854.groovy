...
class Utils {
	...
	public Utils(){
		...
		command = 'iriscli service  refund-deposit --chain-id='.concat(GlobalVariable.chainId).concat(' --def-chain-id=').concat(GlobalVariable.chainId).concat(' --node=').concat(GlobalVariable.node).concat(
