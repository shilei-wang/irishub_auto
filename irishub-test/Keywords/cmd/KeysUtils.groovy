...
public class KeysUtils {
	...
	public static Map<String, String> add(String pw){
		...
		String msg = response.responseBodyContent
		msg = msg.substring(msg.indexOf("password.")+11, msg.length()-1)  //注意前后的回车符 /n

		account_map.put("name", name)
		account_map.put("mnemonic", msg)
		return account_map
	}
