...
public class GovUtils {
	...
	@Keyword
	public static ResponseObject proposalSubmit(String account, String password, String title, String description, String proposal_type, String initial_deposit){
